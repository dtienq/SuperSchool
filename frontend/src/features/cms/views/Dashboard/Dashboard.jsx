...
import Table from '@cmscomponents/Table/Table.jsx';
import Button from '@cmscomponents/CustomButtons/Button.jsx';
import StatsCard from '@cmscomponents/Cards/StatsCard.jsx';
import ChartCard from '@cmscomponents/Cards/ChartCard.jsx';
...
import {
  ...
  completedTasksChart,
} from '@cmsvariables/charts';

import dashboardStyle from '@cmsassets/jss/material-dashboard-pro-react/views/dashboardStyle';

import priceImage1 from '@cmsassets/img/card-2.jpeg';
import priceImage2 from '@cmsassets/img/card-3.jpeg';
import priceImage3 from '@cmsassets/img/card-1.jpeg';

const us_flag = require('@cmsassets/img/flags/US.png');
const de_flag = require('@cmsassets/img/flags/DE.png');
const au_flag = require('@cmsassets/img/flags/AU.png');
const gb_flag = require('@cmsassets/img/flags/GB.png');
const ro_flag = require('@cmsassets/img/flags/RO.png');
const br_flag = require('@cmsassets/img/flags/BR.png');
